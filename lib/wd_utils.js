 ...
 * @param {boolean} volatile - the element can be modified dynamically
 */
exports.click = async function (name, xpath, sec = exports.default_timings.wait, volatile = false) {
  ...
  if (volatile) {
    element = await exports.driver.findElement(By.xpath(xpath))
  }
  await element.click()
}
